...
<body>
    ...
    <div id="RushYes">
      ...
      <br />
      <asp:Label runat="server" Text="Order Name: "></asp:Label>
      <asp:TextBox ID="OrderName" runat="server"></asp:TextBox>
      <br />
      <asp:Label ID="Label2" runat="server" Text="Customer Name: "></asp:Label>
      <asp:TextBox ID="CusomerName" runat="server"></asp:TextBox>
      <br />
      ...
      <br />
      <asp:Label ID="Label5" runat="server" Text="Part Numer: "></asp:Label>
      <asp:TextBox ID="PartNumber" runat="server" Width="36px"></asp:TextBox>
      <br />
